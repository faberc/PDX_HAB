{ECE103 Comments: This is a program that decodes packet radio. We are primarily concerned with AFSK1200 decoding which is what APRS is coded in, so we need to work on understanding that.

Learning how it is coded and decoded can help us in our programming.}
