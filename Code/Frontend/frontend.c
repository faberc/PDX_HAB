...
//  APRS Radio
//
//  Created by Abdulrahman Alamar on 6/12/18.
...
//
//  This script reads from the RawPackets.txt file and parses the data from the raw packets to produce on the screen. It displays various colors and a map (currently hardcoded).
//
